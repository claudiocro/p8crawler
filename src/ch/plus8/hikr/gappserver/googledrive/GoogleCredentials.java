...
public class GoogleCredentials {
	...
	private static final String REDIRECT_URI = "localhost:8888";
	...
	static Credential getStoredCredentials(String userId) {
		...
		new AppEngineCredentialStore().load(userId, credential);
		return credential;
	}
	...
	static void storeCredentials(String userId, Credential credentials) {
		new AppEngineCredentialStore().store(userId, credentials);
	}
	 ...
	 * @throws IOException
	 *             Unable to load clientsecrets.json.
	 */
	static GoogleAuthorizationCodeFlow getFlow() throws IOException {
		if (flow == null) {
			HttpTransport httpTransport = new NetHttpTransport();
			JacksonFactory jsonFactory = new JacksonFactory();
			//GoogleClientSecrets clientSecrets = GoogleClientSecrets.load(jsonFactory, GoogleCredentials.class.getResourceAsStream(CLIENTSECRETS_LOCATION));
			flow = new GoogleAuthorizationCodeFlow.Builder(
					httpTransport, 
					jsonFactory, 
					"597361721424-9ggbqtai0djdihtpkk58b3e5a2dfa7pq.apps.googleusercontent.com",
					"qx1c56YWobrevp1xIdd4Kz4w",
